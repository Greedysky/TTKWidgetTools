...
include(colorTablePlane/ColorTablePlane.pri)
...
include(progressWidget/ProgressWidget.pri)
include(radioButtonWidget/RadioButtonWidget.pri)
include(roundAnimationLabel/RoundAnimationLabel.pri)
include(shiningSlider/ShiningSlider.pri)
include(sliderWidget/SliderWidget.pri)
