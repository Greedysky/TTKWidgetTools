#ifndef TTKRADIUSPROGRESSWIDGETPROPERTY_H
#define TTKRADIUSPROGRESSWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKRadiusProgressWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKRADIUSPROGRESSWIDGETPROPERTY_H
