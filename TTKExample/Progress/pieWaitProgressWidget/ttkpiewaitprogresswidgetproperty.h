#ifndef TTKPIEWAITPROGRESSWIDGETPROPERTY_H
#define TTKPIEWAITPROGRESSWIDGETPROPERTY_H
 ...
 */
class TTK_MODULE_EXPORT TTKPieWaitProgressWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
    explicit TTKPieWaitProgressWidgetProperty(QWidget *parent = nullptr);
...
#endif // TTKPIEWAITPROGRESSWIDGETPROPERTY_H
