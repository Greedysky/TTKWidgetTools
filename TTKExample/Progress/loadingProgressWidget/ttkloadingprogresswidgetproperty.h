#ifndef TTKLOADINGPROCESSWIDGETPROPERTY_H
#define TTKLOADINGPROCESSWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKLoadingProgressWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKLOADINGPROCESSWIDGETPROPERTY_H
