    ...
    : TTKWidgetProperty(parent)
{
    ...
    m_stringManager->setValue(classNameItem, TTKObject_cast(TTKAnSplashScreen*, m_label)->className());
...
{
    TTKAnSplashScreen *widget = TTKObject_cast(TTKAnSplashScreen*, m_label);
