    ...
    : TTKWidgetProperty(parent)
{
    ...
    m_stringManager->setValue(classNameItem, TTKStatic_cast(TTKSplashScreen*, m_label)->getClassName());
...
{
    TTKSplashScreen *widget = TTKStatic_cast(TTKSplashScreen*, m_label);
