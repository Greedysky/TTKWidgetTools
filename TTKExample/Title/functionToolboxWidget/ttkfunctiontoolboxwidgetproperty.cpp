    ...
    : TTKWidgetProperty(parent)
{
    ...
    m_stringManager->setValue(classNameItem, TTKObject_cast(TTKFunctionToolBoxWidget*, m_item)->className());
    ...
    TTKFunctionToolBoxWidget *widget = TTKObject_cast(TTKFunctionToolBoxWidget*, m_item);
