#ifndef TTKSPEEDRINGMETERWIDGETPROPERTY_H
#define TTKSPEEDRINGMETERWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKSpeedRingMeterWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
    explicit TTKSpeedRingMeterWidgetProperty(QWidget *parent = nullptr);
    virtual ~TTKSpeedRingMeterWidgetProperty();
...
#endif // TTKSPEEDRINGMETERWIDGETPROPERTY_H
