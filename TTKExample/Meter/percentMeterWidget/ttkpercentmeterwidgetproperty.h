#ifndef TTKPERCENTMETERWIDGETPROPERTY_H
#define TTKPERCENTMETERWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKPercentMeterWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKPERCENTMETERWIDGETPROPERTY_H
