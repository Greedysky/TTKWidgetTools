#ifndef TTKCOMPASSMETERWIDGETPROPERTY_H
#define TTKCOMPASSMETERWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKCompassMeterWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
    explicit TTKCompassMeterWidgetProperty(QWidget *parent = nullptr);
    virtual ~TTKCompassMeterWidgetProperty();
...
#endif // TTKCOMPASSMETERWIDGETPROPERTY_H
