#ifndef TTKPROGRESSMETERWIDGETPROPERTY_H
#define TTKPROGRESSMETERWIDGETPROPERTY_H
...
class TTK_CORE_EXPORT TTKProgressMeterWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
    explicit TTKProgressMeterWidgetProperty(QWidget *parent = nullptr);
    virtual ~TTKProgressMeterWidgetProperty();
