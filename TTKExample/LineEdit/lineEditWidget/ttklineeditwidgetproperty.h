#ifndef TTKLINEEDITWIDGETPROPERTY_H
#define TTKLINEEDITWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKLineEditWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKLINEEDITWIDGETPROPERTY_H
