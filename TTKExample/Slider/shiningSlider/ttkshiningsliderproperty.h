#ifndef TTKSHININGSLIDERPROPERTY_H
#define TTKSHININGSLIDERPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKShiningSliderProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKSHININGSLIDERPROPERTY_H
