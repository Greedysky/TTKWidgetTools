#ifndef TTKFLATBUTTONWIDGETPROPERTY_H
#define TTKFLATBUTTONWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKFlatButtonWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
    explicit TTKFlatButtonWidgetProperty(QWidget *parent = nullptr);
    virtual ~TTKFlatButtonWidgetProperty();
...
#endif // TTKFLATBUTTONWIDGETPROPERTY_H
