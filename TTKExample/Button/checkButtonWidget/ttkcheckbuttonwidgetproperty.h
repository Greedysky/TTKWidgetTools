#ifndef TTKCHECKBUTTONWIDGETPROPERTY_H
#define TTKCHECKBUTTONWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKCheckButtonWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
    explicit TTKCheckButtonWidgetProperty(QWidget *parent = nullptr);
    virtual ~TTKCheckButtonWidgetProperty();
...
#endif // TTKCHECKBUTTONWIDGETPROPERTY_H
