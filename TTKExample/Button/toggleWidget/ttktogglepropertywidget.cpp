#include "ttktogglepropertywidget.h"
#include "ttktogglewidget.h"

TTKTogglePropertyWidget::TTKTogglePropertyWidget(QWidget *parent)
...
TTKTogglePropertyWidget::~TTKTogglePropertyWidget()
{

}

void TTKTogglePropertyWidget::boolPropertyChanged(QtProperty *property, bool value)
{
...
void TTKTogglePropertyWidget::enumPropertyChanged(QtProperty *property, int value)
{
    TTKToggleWidget *widget = MStatic_cast(TTKToggleWidget*, m_item);
...
void TTKTogglePropertyWidget::colorPropertyChanged(QtProperty *property, const QColor &value)
{
    TTKToggleWidget *widget = MStatic_cast(TTKToggleWidget*, m_item);
