#ifndef TTKRADIOBUTTONWIDGETPROPERTY_H
#define TTKRADIOBUTTONWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKRadioButtonWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
    explicit TTKRadioButtonWidgetProperty(QWidget *parent = nullptr);
    virtual ~TTKRadioButtonWidgetProperty();
...
#endif // TTKRADIOBUTTONWIDGETPROPERTY_H
