#ifndef TTKCOLORBUTTONWIDGETPROPERTY_H
#define TTKCOLORBUTTONWIDGETPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKColorButtonWidgetProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKCOLORBUTTONWIDGETPROPERTY_H
