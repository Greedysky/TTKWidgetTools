#ifndef TTKLEDPAGELABELROPERTY_H
#define TTKLEDPAGELABELROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKLedPageLabelProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKLEDPAGELABELROPERTY_H
