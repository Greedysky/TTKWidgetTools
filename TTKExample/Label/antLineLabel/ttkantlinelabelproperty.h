#ifndef TTKANTLINELABELPROPERTY_H
#define TTKANTLINELABELPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKAntLineLabelProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKANTLINELABELPROPERTY_H
