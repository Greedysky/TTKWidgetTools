#ifndef TTKROUNDANIMATIONLABELPROPERTY_H
#define TTKROUNDANIMATIONLABELPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKRoundAnimationLabelProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKROUNDANIMATIONLABELPROPERTY_H
