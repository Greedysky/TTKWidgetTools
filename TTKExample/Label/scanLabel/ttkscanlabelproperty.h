#ifndef TTKSCANLABELROPERTY_H
#define TTKSCANLABELROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKScanLabelProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
