#ifndef TTKLIGHTPOINTLABELPROPERTY_H
#define TTKLIGHTPOINTLABELPROPERTY_H
...
*/
class TTK_MODULE_EXPORT TTKLightPointLabelProperty : public TTKWidgetProperty
{
    Q_OBJECT
public:
...
#endif // TTKLIGHTPOINTLABELPROPERTY_H
